// Example recipe content for template posts
const recipeExampleContent = `Hey #BakersOfRecipePal, ready to level up your dessert game? This rich, dreamy chocolate cake is:
...
export default recipeExampleContent;
